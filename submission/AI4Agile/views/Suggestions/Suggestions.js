...
function generateSuggestions(processType, issueKey, sliderValue) {
    ...
    switch (processType) {
        ...
        case 'epicDecomposition':
            ...
            $.ajax({
                type: "POST",
                url: "https://ai4agile.azurewebsites.net/epicDecompositionCreateSuggestions",
                crossDomain: true,
                data: jsonOfIssueKey,
        ...
        case 'storyOptimization':
            ...
            $.ajax({
                type: "POST",
                url: "https://ai4agile.azurewebsites.net/storyOptimizationCreateSuggestions",
                crossDomain: true,
                data: jsonOfIssueKey,
                contentType: "application/json",
                success: function (data) {
        ...
        case 'taskGeneration':
            ...
            $.ajax({
                type: "POST",
                url: "https://ai4agile.azurewebsites.net/taskGenerationCreateSuggestions",
                crossDomain: true,
                data: jsonOfIssueKey,
                contentType: "application/json",
                success: function (data) {
...
function createSelectedSuggestions() {
    ...
    switch (processType) {
        ...
        case 'epicDecomposition':
            ...
            $.ajax({
                type: "POST",
                url: "https://ai4agile.azurewebsites.net/epicDecompositionCreateIssues",
                crossDomain: true,
        ...
        case 'storyOptimization':
            ...
            $.ajax({
                type: "POST",
                url: "https://ai4agile.azurewebsites.net/storyOptimizationCreateIssues",
                crossDomain: true,
                data: JSON.stringify(suggestionsToSend),
                contentType: "application/json",
            });
        ...
        case 'taskGeneration':
            ...
            $.ajax({
                type: "POST",
                url: "https://ai4agile.azurewebsites.net/taskGenerationCreateIssues",
                crossDomain: true,
                data: JSON.stringify(suggestionsToSend),
                contentType: "application/json",
            });
