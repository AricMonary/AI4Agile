...
In order to get hands-on experience with this application, login at this \href{https://id.atlassian.com/login?continue=https\%3A\%2F\%2Fai4agile.atlassian.net\%2Flogin\%3FredirectCount\%3D1\%26application\%3Djira\&application=jira}{Jira website portal.} The credentials for this trial usage are \textbf{Email:} AI4Agile@gmail.com, \textbf{Password:} SCORE2021. After logging in, you'll see a project called AI4Agile Demo. For the optimal user experience, navigate to the roadmap to try out the provided features.
